...
class QuestionsTest < ApplicationSystemTestCase
  ...
  test "creating a Question" do
    ...
    fill_in "End time", with: @question.end_time
    check "Escalated" if @question.escalated
    check "Resolved" if @question.resolved
    fill_in "Start time", with: @question.start_time
    fill_in "Time", with: @question.time
    fill_in "Title", with: @question.title
    fill_in "User", with: @question.user_id
    fill_in "Username", with: @question.username
